          ...
          <div className="flex flex-col gap-4 items-center lg:items-start flex-shrink-0">
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center rounded" style={{
                ...
                <p className="font-sketch text-[#9a8a7a] text-xs text-center mt-1 px-2">
                  add your photo here
                </p>
              </div>
              <p className="font-hand lowercase-all text-[#7a6a5a] text-lg mt-1 text-center" style={{ transform: 'rotate(-1deg)' }}>
