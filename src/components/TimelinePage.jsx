...
const entries = [
  ...
  },
  {
    year: '2024',
    emoji: '💧',
    title: 'DSİ – State Hydraulic Works',
  ...
  },
  {
    year: '2024',
    emoji: '⚡',
    title: 'Enerjisa Üretim, İstanbul',
    ...
    <div className="min-h-screen py-12 px-4 relative" style={{ background: '#faf7f2' }}>
      ...
      <div className="max-w-4xl mx-auto pl-10 sm:pl-16 relative">
        ...
        >
          ...
          <p className="font-patrick text-[#7a6a5a] mt-1"
        ...
        <div className="relative">
          ...
          <svg className="absolute left-1/2 top-0 -translate-x-1/2 h-full" width="60" style={{ zIndex: 0 }}>
            <path
              d="M30 0 Q40 120 20 240 Q10 360 30 480 Q50 600 30 720 Q10 840 30 960 Q50 1080 30 1200"
          ...
          {years.map((year, yi) => {
            ...
            return (
              <div key={year} className="mb-4">
                ...
                >
                  <div className="font-caveat text-2xl font-bold px-4 py-1 rounded-full"
                    style={{
                      background: '#3d2b1f',
                      color: '#fde68a',
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="flex items-center gap-3 mt-4 mb-8"
          >
            <div className="font-caveat text-lg text-[#7a6a5a] italic">
              — to be continued... 🌱
            </div>
          </motion.div>
        </div>
